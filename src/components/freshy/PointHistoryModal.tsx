...
export default function PointHistoryModal({
  ...
  return (
    ...
    >
      {/* Centered Modal Card */}
      <div 
        className="flex max-h-[80vh] w-full max-w-md flex-col overflow-hidden rounded-[32px] border-2 border-white/60 bg-white/40 shadow-cartoon backdrop-blur-lg"
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        {transactions.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center text-neutral-400">
            ...
            <p className="text-body font-semibold">{t("history.emptyTitle")}</p>
